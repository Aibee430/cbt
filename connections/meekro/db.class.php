...
public static $dbName   = 'report';
public static $user     = 'postgres';
public static $password = '';
public static $host     = '';
public static $port     = 5432;          // PostgreSQL default port
public static $socket   = null;
public static $encoding = 'utf8';         // Recommended for PostgreSQL
public static $dbType   = 'pgsql';         // IMPORTANT
...
public  $port     = 5432;          // PostgreSQL default port
public  $socket   = null;
public  $encoding = 'utf8';         // Recommended for PostgreSQL
public  $dbType   = 'pgsql';         // IMPORTANT
