    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="studentNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item"><a class="nav-link" href="/cbt/student/dashboard.php">Dashboard</a></li>
                <li class="nav-item"><a class="nav-link" href="/cbt/student/results.php">Results</a></li>
            </ul>
            <span class="navbar-text text-light me-3"><?php echo htmlspecialchars($_SESSION['student']['name']); ?></span>
            <a class="btn btn-outline-light btn-sm" href="/cbt/student/logout.php">Logout</a>
        </div>
    </div>
</nav>
